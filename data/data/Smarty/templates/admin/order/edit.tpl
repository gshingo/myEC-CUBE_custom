...
<input type="hidden" id="select_sell_piece_size" name="select_sell_piece_size" value="" />
<input type="hidden" id="select_body_color_classcategory_id" name="select_body_color_classcategory_id" value="" />
<input type="hidden" id="select_back_color_classcategory_id" name="select_back_color_classcategory_id" value="" />
<input type="hidden" id="select_edge_color_classcategory_id" name="select_edge_color_classcategory_id" value="" />
<input type="hidden" id="select_edge_size_classcategory_id" name="select_edge_size_classcategory_id" value="" />
<input type="hidden" id="select_width_size" name="select_width_size" value="" />
<input type="hidden" id="select_height_size" name="select_height_size" value="" />
<input type="hidden" id="select_frill_id" name="select_frill_id" value="" />
    ...
    <table class="list" id="order-edit-products">
        ...
        <tr>
            ...
            <td>
                ...
                <!--{*if $arrForm.body_color_classcategory_id.value[$product_index] == "" && $arrForm.width_size.value[$product_index] != ""*}-->
                <!--{if $JB_Stainplate_flg[$product_index] == 1}-->
                    <!--JBステンプレート-->
                    W：<input type="text" name="width_size[<!--{$product_index}-->]" value="<!--{$arrForm.width_size.value[$product_index]|h}-->" id="width_size_<!--{$product_index}-->" />cm(<!--{$arrForm.classcategory_name1.value[$product_index]|default:"なし"|h}-->)
                    /
                    H：<!--{$arrForm.classcategory_name2.value[$product_index]|default:"(なし)"|h}-->
                <!--{else}-->
                    <!--{$arrForm.classcategory_name1.value[$product_index]|default:"(なし)"|h}-->
                    <!--{if $arrColor1[$product_index] != ""}-->
                        ：<!--{$arrColor1[$product_index]}-->
                    <!--{/if}-->
                    <!--{if $arrForm.classcategory_name1.value[$product_index] != "" && $sell_piece_flg[$product_index] == 1}-->
                        ：<input type="text" name="sell_piece_size[<!--{$product_index}-->]" value="<!--{$arrForm.sell_piece_size.value[$product_index]|h}-->" id="sell_piece_size_<!--{$product_index}-->" />m
                    <!--{else}-->
                        <input type="hidden" name="sell_piece_size[<!--{$product_index}-->]" value="<!--{$arrForm.sell_piece_size.value[$product_index]|h}-->" id="sell_piece_size_<!--{$product_index}-->" />
                    <!--{/if}-->
                    /
                    <!--{$arrForm.classcategory_name2.value[$product_index]|default:"(なし)"|h}-->
                    <!--{if $arrColor2[$product_index] != ""}-->
                        ：<!--{$arrColor2[$product_index]}-->
                    <!--{/if}-->
                    <!--{if $arrForm.classcategory_name2.value[$product_index] != "" && $sell_piece_flg[$product_index] == 1}-->
                        ：<input type="text" name="sell_piece_size[<!--{$product_index}-->]" value="<!--{$arrForm.sell_piece_size.value[$product_index]|h}-->" id="sell_piece_size_<!--{$product_index}-->" />m
                    <!--{else}-->
                        <input type="hidden" name="sell_piece_size[<!--{$product_index}-->]" value="<!--{$arrForm.sell_piece_size.value[$product_index]|h}-->" id="sell_piece_size_<!--{$product_index}-->" />
                    <!--{/if}-->
                    <!--{if $semi_order_made_flg[$product_index] == 1}-->
                        <br />フレンジフリル：<select name="frill_id[<!--{$product_index}-->]" id="frill_id_<!--{$product_index}-->">
                            <!--{html_options options=$arrFrill selected=$arrForm.frill_id.value[$product_index]}-->
                        </select>
                    <!--{else}-->
                        <input type="hidden" name="frill_id[<!--{$product_index}-->]" value="<!--{$arrForm.frill_id.value[$product_index]|h}-->" id="frill_id_<!--{$product_index}-->" />
                    <!--{/if}-->
                    <!--{if $order_made_flg[$product_index] == 1}-->
                        <br />表の色：<select name="body_color_classcategory_id[<!--{$product_index}-->]" id="body_color_classcategory_id_<!--{$product_index}-->">
                            <!--{html_options options=$arrBodyCategory[$product_index] selected=$arrForm.body_color_classcategory_id.value[$product_index]}-->
                        </select>
                    <!--{else}-->
                        <input type="hidden" name="body_color_classcategory_id[<!--{$product_index}-->]" value="<!--{$arrForm.body_color_classcategory_id.value[$product_index]|h}-->" id="body_color_classcategory_id_<!--{$product_index}-->" />
                    <!--{/if}-->
                    <!--{if $order_made_flg[$product_index] == 1 && $back_color_flg[$product_index] != ""}-->
                        <br />裏の色：<select name="back_color_classcategory_id[<!--{$product_index}-->]" id="back_color_classcategory_id_<!--{$product_index}-->">
                            <!--{html_options options=$arrBackCategory[$product_index] selected=$arrForm.back_color_classcategory_id.value[$product_index]}-->
                        </select>
                    <!--{else}-->
                        <input type="hidden" name="back_color_classcategory_id[<!--{$product_index}-->]" value="<!--{$arrForm.back_color_classcategory_id.value[$product_index]|h}-->" id="back_color_classcategory_id_<!--{$product_index}-->" />
                    <!--{/if}-->
                    <!--{if $order_made_flg[$product_index] == 1}-->
                        <br />フチの色：<select name="edge_color_classcategory_id[<!--{$product_index}-->]" id="edge_color_classcategory_id_<!--{$product_index}-->">
                            <!--{html_options options=$arrEdgeCategory[$product_index] selected=$arrForm.edge_color_classcategory_id.value[$product_index]}-->
                        </select>
                    <!--{else}-->
                        <input type="hidden" name="edge_color_classcategory_id[<!--{$product_index}-->]" value="<!--{$arrForm.edge_color_classcategory_id.value[$product_index]|h}-->" id="edge_color_classcategory_id_<!--{$product_index}-->" />
                    <!--{/if}-->
                    <!--{if $order_made_flg[$product_index] == 1}-->
                        <br />フチサイズ：<select name="edge_size_classcategory_id[<!--{$product_index}-->]" id="edge_size_classcategory_id_<!--{$product_index}-->">
                            <!--{html_options options=$arrSizeCategory[$product_index] selected=$arrForm.edge_size_classcategory_id.value[$product_index]}-->
                        </select>
                    <!--{else}-->
                        <input type="hidden" name="edge_size_classcategory_id[<!--{$product_index}-->]" value="<!--{$arrForm.edge_size_classcategory_id.value[$product_index]|h}-->" id="edge_size_classcategory_id_<!--{$product_index}-->" />
                    <!--{/if}-->
                    <!--{if $order_made_flg[$product_index] == 1}-->
                        <br />横サイズ：<input type="text" name="width_size[<!--{$product_index}-->]" value="<!--{$arrForm.width_size.value[$product_index]|h}-->" id="width_size_<!--{$product_index}-->" />cm
                        <!--{else}-->
                        <input type="hidden" name="width_size[<!--{$product_index}-->]" value="<!--{$arrForm.width_size.value[$product_index]|h}-->" id="width_size_<!--{$product_index}-->" />
                    <!--{/if}-->
                    <!--{if $order_made_flg[$product_index] == 1}-->
                        <br />縦サイズ：<input type="text" name="height_size[<!--{$product_index}-->]" value="<!--{$arrForm.height_size.value[$product_index]|h}-->" id="height_size_<!--{$product_index}-->" />cm
                        <!--{else}-->
                        <input type="hidden" name="height_size[<!--{$product_index}-->]" value="<!--{$arrForm.height_size.value[$product_index]|h}-->" id="height_size_<!--{$product_index}-->" />
                    <!--{/if}-->
                <!--{/if}-->
