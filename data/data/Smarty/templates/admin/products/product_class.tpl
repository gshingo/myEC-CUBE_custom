        ...
        <!--{section name=cnt loop=$arrForm.total.value}-->
            ...
            <tr>
                ...
                <td class="center">
                    ...
                    <!--{if $arrForm.price_rank1.value[$index] != ""}-->
                        <br /><!--{assign var=price_rank value=$arrForm.price_rank1.value[$index]}-->
                        <!--{$arrPriceRank[$price_rank]|h}-->:<!--{$arrForm.color1.value[$index]|h}-->
                    <!--{/if}-->
                    <input type="hidden" name="<!--{$key}-->[<!--{$index}-->]" value="<!--{$arrForm[$key].value[$index]|h}-->" />
                </td>
                <td class="center">
