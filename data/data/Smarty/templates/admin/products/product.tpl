...
<div id="products" class="contents-main">
    ...
    <table class="form">
        ...
        <tr>
            <th>イベント登録</th>
            <td>
                <span class="attention"><!--{$arrErr.event_flg}--></span>
                <!--{html_checkboxes name="event_flg" options=$arrEVENT selected=$arrForm.event_flg}-->
            </td>
        </tr>
        <tr>
            <th>セミオーダー商品</th>
            <td>
                <!--{assign var="key" value="semi_order_made_flg"}-->
                <!--{html_radios name=$key options=$arrOPTIONITEM selected=$arrForm[$key] separator='&nbsp;&nbsp;'}-->
            </td>
        </tr>
        <tr>
            <th>セミオーダーオプション商品</th>
            <td>
                <!--{assign var="key" value="option_item_flg"}-->
                <!--{html_radios name=$key options=$arrOPTIONITEM selected=$arrForm[$key] separator='&nbsp;&nbsp;'}-->
            </td>
        </tr>
        <tr>
            <th>切り売り可能商品</th>
            <td>
                <!--{assign var="key" value="sell_piece_flg"}-->
                <!--{html_radios name=$key options=$arrOPTIONITEM selected=$arrForm[$key] separator='&nbsp;&nbsp;'}-->
            </td>
        </tr>
        <tr>
            <th>表示単位</th>
            <td>
                <span class="attention"><!--{$arrErr.unit_id}--></span>
                <select name="unit_id" style="<!--{$arrErr.unit_id|sfGetErrorColor}-->">
                    <option value="">選択してください</option>
                    <!--{html_options options=$arrUNIT selected=$arrForm.unit_id}-->
                </select>
            </td>
        </tr>
        <tr>
    ...
    <div class="btn">
        <a class="btn-normal" href="javascript:;" onclick="selectAll('category_id'); lfDispSwitch('ordermade_select'); return false;"><span>オーダーメイド情報表示/非表示</span></a>
    </div>

    <!--{if $arrForm.ordermade_find == true}-->
    <div id="ordermade_select" style="">
    <!--{else}-->
    <div id="ordermade_select" style="display:none">
    <!--{/if}-->
    <h2>オーダーメイド情報</h2>
    <table class="form">
        <tr>
            <th>表の色選択</th>
            <td>
                <!--{assign var="key" value="body_color_class_id"}-->
                <span class="attention"><!--{$arrErr[$key]}--></span>
                <select name="<!--{$key}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->">
                    <option value="">選択してください</option>
                    <!--{html_options options=$arrClass selected=$arrForm[$key]}-->
                </select>
            </td>
        </tr>
        <tr>
            <th>裏の色選択</th>
            <td>
                <!--{assign var="key" value="back_color_class_id"}-->
                <span class="attention"><!--{$arrErr[$key]}--></span>
                <select name="<!--{$key}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->">
                    <option value="">選択してください</option>
                    <!--{html_options options=$arrClass selected=$arrForm[$key]}-->
        ...
        <tr>
            <th>フチの色選択</th>
            <td>
                <!--{assign var="key" value="edge_color_class_id"}-->
                <span class="attention"><!--{$arrErr[$key]}--></span>
                <select name="<!--{$key}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->">
                    <option value="">選択してください</option>
                    <!--{html_options options=$arrClass selected=$arrForm[$key]}-->
        ...
        <tr>
            <th>フチのサイズ選択</th>
            <td>
                <!--{assign var="key" value="edge_size_class_id"}-->
                <span class="attention"><!--{$arrErr[$key]}--></span>
                <select name="<!--{$key}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->">
                    <option value="">選択してください</option>
                    <!--{html_options options=$arrClass selected=$arrForm[$key]}-->
