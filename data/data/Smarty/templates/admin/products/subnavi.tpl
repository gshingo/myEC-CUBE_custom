...
<li<!--{if $tpl_subno == 'class_cloth'}--> class="on"<!--{/if}--> id="navi-products-class-cloth"><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->products/class_cloth.php"><span>生地管理</span></a></li>
<li<!--{if $tpl_subno == 'class_JB_Size'}--> class="on"<!--{/if}--> id="navi-products-class-jb-size"><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->products/class_JB_Size.php"><span>サイズ管理</span></a></li>
<!--{/if}-->
...
<li<!--{if $tpl_subno == 'event'}--> class="on"<!--{/if}--> id="navi-products-event"><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->products/event.php"><span>イベント管理</span></a></li>
<li<!--{if $tpl_subno == 'unit_reg'}--> class="on"<!--{/if}--> id="navi-products-unit-reg"><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->products/unit_reg.php"><span>単位管理</span></a></li>
</ul>
