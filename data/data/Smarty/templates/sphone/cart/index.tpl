                                    ...
                                    <div class="cartinContents">
                                        <div>
                                            <p><em><!--{$arrItem.productsClass.name|h}--></em><br />
                                                <!--{if $arrItem.is_JBStainplate == true}-->
                                                    <!--{if $arrItem.productsClass.classcategory_name2 != ""}-->
                                                        <span class="mini">縦：<!--{$arrItem.productsClass.classcategory_name2}--></span><br />
                                                    <!--{/if}-->
                                                    <!--{if $arrItem.width_size != ""}-->
                                                        <span class="mini">横：<!--{$arrItem.width_size}-->cm</span><br />
                                                    <!--{/if}-->
                                                <!--{else}-->
                                                    <!--{if $arrItem.productsClass.classcategory_name1 != ""}-->
                                                        <span class="mini">
                                                            <!--{if $arrItem.productsClass.class_name1|@strpos:"車種名" !== FALSE}-->
                                                                <!--{assign var=class_name1 value="車種"}-->
                                                            <!--{else}-->
                                                                <!--{assign var=class_name1 value=$arrItem.productsClass.class_name1}-->
                                                            <!--{/if}-->
                                                            <!--{$class_name1}-->：<!--{$arrItem.productsClass.classcategory_name1}-->
                                                            <!--{if $arrItem.color1 != ""}-->
                                                               ：<!--{$arrItem.color1}-->
                                                            <!--{/if}-->
                                                        </span><br />
                                                    ...
                                                    <!--{if $arrItem.productsClass.classcategory_name2 != ""}-->
                                                        <span class="mini">
                                                            <!--{if $arrItem.productsClass.class_name2|@strpos:"車種名" !== FALSE}-->
                                                                <!--{assign var=class_name2 value="車種"}-->
                                                            <!--{else}-->
                                                                <!--{assign var=class_name2 value=$arrItem.productsClass.class_name2}-->
                                                            <!--{/if}-->
                                                            <!--{$class_name2}-->：<!--{$arrItem.productsClass.classcategory_name2}-->
                                                            <!--{if $arrItem.color2 != ""}-->
                                                               ：<!--{$arrItem.color2}-->
                                                            <!--{/if}-->
                                                        </span><br />
                                                    <!--{/if}-->
                                                    <!--{if $arrItem.frill_name != ""}-->
                                                        <span class="mini"><!--{$arrItem.frill_name}--></span><br />
                                                    <!--{/if}-->
                                                <!--{/if}-->
                                                <!--{if $arrItem.body_color_classcategory_id != ""}-->
                                                    <span class="mini">表の色：<!--{$arrItem.body_color_classcategory_name}--></span><br />
                                                <!--{/if}-->
                                                <!--{if $arrItem.back_color_classcategory_id != ""}-->
                                                    <span class="mini">裏の色：<!--{$arrItem.back_color_classcategory_name}--></span><br />
                                                <!--{/if}-->
                                                <!--{if $arrItem.edge_color_classcategory_id != ""}-->
                                                    <span class="mini">フチの色：<!--{$arrItem.edge_color_classcategory_name}--></span><br />
                                                <!--{/if}-->
                                                <!--{if $arrItem.edge_size_classcategory_id != ""}-->
                                                    <span class="mini">フチサイズ：<!--{$arrItem.edge_size_classcategory_name}--></span><br />
                                                <!--{/if}-->
                                                <!--{if $arrItem.height_size != ""}-->
                                                    <span class="mini">横：<!--{$arrItem.width_size}-->cm × 縦：<!--{$arrItem.height_size}-->cm</span><br />
                                                <!--{/if}-->
