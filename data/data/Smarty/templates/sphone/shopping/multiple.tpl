<!--{*
/* Spirit of verup program Security Update 2013/05 v1.0 updated
   /var/www/html/user_data/update201305.php
            ...
            <!--{section name=line loop=$arrForm.line_of_num.value}-->
                ...
                <div class="formBox">
                    ...
                    <div class="btn_area_btm">
                        ...
                        <select name="<!--{$key}-->[<!--{$index}-->]" class="boxLong data-role-none"><!--{html_options options=$addrs selected=$arrForm[$key].value[$index]|h}--></select>
                    </div>
