...
<nav id="gnav">
    <ul>
        <li class="cart"><a href="<!--{$smarty.const.ROOT_URLPATH}-->cart/">カート</a></li>
        <!--{if $tpl_login}-->
            <li class="logout"><a href="<!--{$smarty.const.ROOT_URLPATH}-->frontparts/login_check.php?mode=logout">ログアウト</a></li>
            <li class="mypage"><a href="<!--{$smarty.const.ROOT_URLPATH}-->mypage/">マイページ</a></li>
        <!--{else}-->
            <li class="login"><a href="<!--{$smarty.const.ROOT_URLPATH}-->mypage/login.php">ログイン</a></li>
            <li class="register"><a href="<!--{$smarty.const.ROOT_URLPATH}-->entry/kiyaku.php">新規会員登録</a></li>
        <!--{/if}-->
        <li class="contact"><a href="<!--{$smarty.const.ROOT_URLPATH}-->contact/">お問い合わせ</a></li>
        <li class="guide"><a href="<!--{$smarty.const.ROOT_URLPATH}-->user_data/utility.php">初めての方へ</a></li>
    </ul>
</nav>
