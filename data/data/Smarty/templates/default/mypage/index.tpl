...
<div id="mypagecolumn">
    ...
    <div id="mycontents_area">
        ...
        <h3><img src="<!--{$TPL_URLPATH}-->img/mypage/subtitle01.gif" width="515" height="32" alt="購入履歴一覧" /></h3>

        <!--{if $objNavi->all_row > 0}-->

            <p><span class=""><!--{$objNavi->all_row}-->件</span>の購入履歴があります。</p>
            ...
            <table summary="購入履歴">
                ...
                <!--{section name=cnt loop=$arrOrder}-->
                    <tr>
                        <td class=""><!--{$arrOrder[cnt].create_date|sfDispDBDate}--></td>
                        <td><!--{$arrOrder[cnt].order_id}--></td>
                        <!--{assign var=payment_id value="`$arrOrder[cnt].payment_id`"}-->
                        <td class=""><!--{$arrPayment[$payment_id]|h}--></td>
