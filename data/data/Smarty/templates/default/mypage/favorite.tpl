...
<div id="mypagecolumn">
    ...
    <div id="mycontents_area">
        ...
        <h3><img src="<!--{$TPL_URLPATH}-->img/mypage/subtitle06.gif" width="515" height="32" alt="お気に入り商品一覧" /></h3>

        <!--{if $tpl_linemax > 0}-->

            <p><span class=""><!--{$tpl_linemax}-->件</span>のお気に入りがあります。</p>
            <div class="paging">
                <!--▼ページナビ-->
                <!--{$tpl_strnavi}-->
                <!--▲ページナビ-->
            ...
            <table summary="お気に入り">
                ...
                *}-->
                ...
                <!--{section name=cnt loop=$arrFavorite}-->
                    ...
                    <tr>
                        <td class=""><a href="javascript:fnModeSubmit('delete_favorite','product_id','<!--{$product_id|h}-->');">削除</a></td>
