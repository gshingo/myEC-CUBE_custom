...
<div id="undercolumn">
    <div id="undercolumn_entry">
        ...
        <form name="form1" id="form1" method="post" action="?">
            ...
            <div class="btn_area">
                        <input type="image" onmouseover="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/common/b_confirm_on.gif',this)" onmouseout="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/common/b_confirm.gif',this)" src="<!--{$TPL_URLPATH}-->img/common/b_confirm.gif" alt="確認ページへ" name="confirm" id="confirm" />
            </div>
