...
<div id="undercolumn">
    <div id="undercolumn_entry">
        ...
        <div class="btn_area">
            <a href="?" onclick="fnModeSubmit('return', '', ''); return false;" onmouseover="chgImg('<!--{$TPL_URLPATH}-->img/common/b_back_on.gif','back')" onmouseout="chgImg('<!--{$TPL_URLPATH}-->img/common/b_back.gif','back')"><img src="<!--{$TPL_URLPATH}-->img/common/b_back.gif" alt="戻る" border="0" name="back" id="back" /></a>&nbsp;
            <input type="image" onmouseover="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/entry/b_entrycomp_on.gif',this)" onmouseout="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/entry/b_entrycomp.gif',this)" src="<!--{$TPL_URLPATH}-->img/entry/b_entrycomp.gif" alt="会員登録をする" border="0" name="send" id="send" />
        </div>
