...
<div id="under02column">
    <div id="under02column_shopping">
        <p class="flow_area">
            <img src="<!--{$TPL_URLPATH}-->img/shopping/flow01.gif" width="700" height="36" alt="購入手続きの流れ" />
        </p>
        <h2 class="title"><img src="<!--{$TPL_URLPATH}-->img/shopping/deliv_title.jpg" width="700" height="40" alt="お届け先の指定" /></h2>
        ...
        <!--{if $tpl_addrmax < $smarty.const.DELIV_ADDR_MAX}-->
            <p class="addbtn">
                <a href="<!--{$smarty.const.ROOT_URLPATH}-->mypage/delivery_addr.php" onclick="win02('<!--{$smarty.const.ROOT_URLPATH}-->mypage/delivery_addr.php?page=<!--{$smarty.server.SCRIPT_NAME|h}-->','new_deiv','600','640'); return false;" onmouseover="chgImg('<!--{$TPL_URLPATH}-->img/common/newadress_on.gif','addition');" onmouseout="chgImg('<!--{$TPL_URLPATH}-->img/common/newadress.gif','addition');"><img src="<!--{$TPL_URLPATH}-->img/common/newadress.gif" alt="新しいお届け先を追加する" name="addition" id="addition" /></a>
            </p>
        <!--{/if}-->
        ...
        <div class="btn_area">
            <a href="<!--{$smarty.const.CART_URLPATH}-->" onmouseover="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/common/b_back_on.gif',back03)" onmouseout="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/common/b_back.gif',back03)"><img src="<!--{$TPL_URLPATH}-->img/common/b_back.gif" alt="戻る" border="0" name="back03" id="back03" /></a>
            <input type="image" onmouseover="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/shopping/b_select_on.gif',this)" onmouseout="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/shopping/b_select.gif',this)" src="<!--{$TPL_URLPATH}-->img/shopping/b_select.gif" alt="選択したお届け先に送る" name="send_button" id="send_button" />
        </div>
