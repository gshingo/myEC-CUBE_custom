...
<div id="under02column">
    <div id="under02column_shopping">
        <p class="flow_area">
            <img src="<!--{$TPL_URLPATH}-->img/shopping/flow02.gif" alt="購入手続きの流れ" />
        </p>
        <h2 class="title"><img src="<!--{$TPL_URLPATH}-->img/shopping/payment_title.jpg" width="700" height="40" alt="お支払い方法、お届け時間等の指定" /></h2>
        ...
        <div class="pay_area">
            <h3><img src="<!--{$TPL_URLPATH}-->img/shopping/subtitle01.gif" width="670" height="33" alt="お支払方法の指定" /></h3>
        ...
        <div class="pay_area02">
            <h3><img src="<!--{$TPL_URLPATH}-->img/shopping/subtitle02.gif" width="670" height="33" alt="お届け時間の指定" /></h3>
        ...
        <div class="pay_area02">
            <h3><img src="<!--{$TPL_URLPATH}-->img/shopping/subtitle03.gif" width="670" height="33" alt="その他お問い合わせ" /></h3>
            <p>
                ◆領収書が必要な場合：こちらに「領収書必要」とご入力の上「領収書名」と「但し書き内容」をお知らせください。<br>
                ◆ご要望・お問合せ事項がございましたらこちらにご入力ください。
            </p>
            <div>
                <!--★その他お問い合わせ事項★-->
        ...
        <!--{if $tpl_login == 1 && $smarty.const.USE_POINT !== false}-->
            <div class="point_area">
                <h3><img src="<!--{$TPL_URLPATH}-->img/shopping/subtitle_point.jpg" width="670" height="32" alt="ポイント使用の指定" /></h3>
                    ...
                    <div class="point_announce">
                        ...
                        <ul>
                            ...
                            <input type="radio" id="point_on" name="point_check" value="1" <!--{$arrForm.point_check.value|sfGetChecked:1}--> onclick="fnCheckInputPoint();" /><label for="point_on">ポイントを使用する</label>
                                <!--{assign var=key value="use_point"}--></li>
                            <li class="underline">
                            今回のお買い物で、<input type="text" name="<!--{$key}-->" value="<!--{$arrForm[$key].value|default:$tpl_user_point}-->" maxlength="<!--{$arrForm[$key].length}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" class="box60" />&nbsp;ポイントを使用する。<span class="attention"><!--{$arrErr[$key]}--></span>
                            </li>
        ...
        <div class="btn_area">
            <a href="?mode=return" onmouseover="chgImg('<!--{$TPL_URLPATH}-->img/common/b_back_on.gif','back03')" onmouseout="chgImg('<!--{$TPL_URLPATH}-->img/common/b_back.gif','back03')"><img src="<!--{$TPL_URLPATH}-->img/common/b_back.gif" alt="戻る" border="0" name="back03" id="back03" /></a>&nbsp;
