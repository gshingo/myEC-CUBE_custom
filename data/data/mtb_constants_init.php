...
/** 商品一覧(HTML出力) */
define('P_LIST_URLPATH', ROOT_URLPATH . "products/list.php");
/** イベント画像横 */
define('DISP_EVENT_WIDTH', 710);
/** イベント画像縦 */
define('DISP_EVENT_HEIGHT', 1000);
/** 生地画像1縦 */
define('DISP_CLOTH_HEIGHT1', 50);
/** 生地画像1横 */
define('DISP_CLOTH_WIDTH1', 130);
/** 生地画像2縦 */
define('DISP_CLOTH_HEIGHT2', 130);
/** 生地画像2横 */
define('DISP_CLOTH_WIDTH2', 130);
