...
/* Spirit of verup program Security Update 2013/06 v1.0 updated
   /var/www/html/user_data/update201306.php
   Spirit of Co.,Ltd. http://www.spiritof.jp/ 
*/
    function EXIST_CHECK_REVERSE_old_20130625191832 ($value) {
        if (isset($this->arrErr[$value[0]])) {
            return;
        }
        $this->createParam($value);
...
/* Spirit of verup program Security Update 2013/06 v1.0 updated
   ...
   Spirit of Co.,Ltd. http://www.spiritof.jp/ 
*/
    function EQUAL_CHECK_old_20130625191832 ($value) {
        if (isset($this->arrErr[$value[2]]) || isset($this->arrErr[$value[3]])) {
            return;
        }
        $this->createParam($value);
...
/* Spirit of verup program Security Update 2013/06 v1.0 updated
   ...
   Spirit of Co.,Ltd. http://www.spiritof.jp/ 
*/
    function DIFFERENT_CHECK_old_20130625191832 ($value) {
        if (isset($this->arrErr[$value[2]]) || isset($this->arrErr[$value[3]])) {
            return;
        }
        $this->createParam($value);
...
/* Spirit of verup program Security Update 2013/06 v1.0 updated
   ...
   Spirit of Co.,Ltd. http://www.spiritof.jp/ 
*/
    function GREATER_CHECK_old_20130625191832 ($value) {
        if (isset($this->arrErr[$value[2]]) || isset($this->arrErr[$value[3]])) {
            return;
        }
        $this->createParam($value);
...
/* Spirit of verup program Security Update 2013/06 v1.0 updated
   ...
   Spirit of Co.,Ltd. http://www.spiritof.jp/ 
*/
    function CHECK_SET_TERM_old_20130625191832 ($value) {
...
/* Spirit of verup program Security Update 2013/06 v1.0 updated
   ...
   Spirit of Co.,Ltd. http://www.spiritof.jp/ 
*/
    function CHECK_SET_TERM2_old_20130625191832 ($value) {
...
/* Spirit of verup program Security Update 2013/06 v1.0 updated
   ...
   Spirit of Co.,Ltd. http://www.spiritof.jp/ 
*/
    function CHECK_SET_TERM3_old_20130625191832 ($value) {
...
/* Spirit of verup program Security Update 2013/06 v1.0 updated
   ...
   Spirit of Co.,Ltd. http://www.spiritof.jp/ 
*/
    function EVAL_CHECK_old_20130625191832 ($value) {
        if (isset($this->arrErr[$value[0]])) {
            return;
        }
        $this->createParam($value);
...
/* Spirit of verup program Security Update 2013/06 v1.0 updated
   ...
   Spirit of Co.,Ltd. http://www.spiritof.jp/ 
*/
    function createParam_old_20130625191832 ($value) {
