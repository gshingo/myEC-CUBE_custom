        ...
        $.post(
            ...
            function(resp, status) {
                if (resp.status == 'SUCCESS') {
                    ...
                    $('#ownersstore_version56').closest('td').next().next().html('<span class="icon_confirm"><a href="#" onclick="win02(\'../load_module_config.php?module_id=56\', \'load\', 615, 400);return false;">設定</a></span>');
                } else {
                    show(resp, status);
                }
            },
